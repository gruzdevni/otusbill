...
/*
PostUserOK Успешное создание пользователя
...
func (o *PostUserOK) WithPayload(payload *models.DefaultStatusResponse) *PostUserOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the post user o k response
func (o *PostUserOK) SetPayload(payload *models.DefaultStatusResponse) {
	o.Payload = payload
}
...
/*
PostUserBadRequest Клиентская ошибка
...
func (o *PostUserBadRequest) WithPayload(payload *models.DefaultStatusResponse) *PostUserBadRequest {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the post user bad request response
func (o *PostUserBadRequest) SetPayload(payload *models.DefaultStatusResponse) {
	o.Payload = payload
}
...
/*
PostUserInternalServerError Серверная ошибка
...
func (o *PostUserInternalServerError) WithPayload(payload *models.DefaultStatusResponse) *PostUserInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the post user internal server error response
func (o *PostUserInternalServerError) SetPayload(payload *models.DefaultStatusResponse) {
	o.Payload = payload
}
